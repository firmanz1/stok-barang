...
.table tbody td img:hover {
                                            ...
                                            <tr>
                                               ...
                                               <div class="modal fade" id="edit<?=$idk;?>">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" name="updatebarangkeluar">Selesaikan tross</button> 
                                                </div>
                                                </form>    
                                             ...
                                             <div class="modal fade" id="delete<?=$idk;?>">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <br>
                                                    <br>
                                                    <button type="submit" class="btn btn-danger" name="hapusbarangkeluar">yakin lah masa engga</button> 
                                                </div>
                                                </form>    
    ...
    <div class="modal fade" id="myModal">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
            <h4 class="modal-title">Tambaha Barang</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
